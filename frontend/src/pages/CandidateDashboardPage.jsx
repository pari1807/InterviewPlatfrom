  ...
  return (
    <AppLayout>
      <div className="space-y-8 animate-fade-in">
        ...
        {/* Resume Builder & Career Suite Section */}
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card className="p-6 flex flex-col justify-between bg-gradient-to-br from-white to-emerald-50/30 border border-emerald-200/80 shadow-sm">
              <div>
                <div className="flex items-center justify-between mb-3">
                  ...
                  <Badge variant="emerald" size="sm">AI Powered</Badge>
                </div>
                <h3 className="text-xl font-bold text-slate-900 mb-2">Build & Edit Resumes</h3>
                <p className="text-slate-500 text-xs leading-relaxed">
                  Create ATS-friendly resumes with modern templates, AI bullet enhancement, and instant PDF import/export.
                </p>
              </div>
            ...
            <Card className="p-6 flex flex-col justify-between bg-gradient-to-br from-white to-teal-50/30 border border-teal-200/80 shadow-sm">
              <div>
                <div className="flex items-center justify-between mb-3">
                  ...
                  <Badge variant="emerald" size="sm">Match Score</Badge>
                </div>
                <h3 className="text-xl font-bold text-slate-900 mb-2">ATS Resume Scanner</h3>
                <p className="text-slate-500 text-xs leading-relaxed">
                  Scan your resume against job descriptions to discover missing keywords, match percentages, and formatting advice.
                </p>
              </div>
